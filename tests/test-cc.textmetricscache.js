...
shouldBe('var a = new CC.LineMetricsCache(); a.update(ctx, "lorem"); a.offsets[0]', '8');
shouldBe('var a = new CC.LineMetricsCache(); a.update(ctx, "lorem"); a.offsets[1]', '16');
shouldBe('var a = new CC.LineMetricsCache(); a.update(ctx, "lorem"); a.offsets[2]', '24');
